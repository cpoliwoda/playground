...
//        //possibiltity 01  Using the Fluent API
//        NumberBinding sum = num1.add(num2);
//        
        //possibiltity 02 Using the Bindings Class
    ...
    // Example 5 Combining Both Approaches  (Using the Fluent API && Using the Bindings Class)
